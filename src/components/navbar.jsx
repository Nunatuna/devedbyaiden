  ...
  return (
    <div className="navbar-container">
      ...
      <div className="navbar-links">
        ...
        <Link to="/" className="navbar-logo-phone"><span className="logo-name">DEVED BY AIDEN</span><span className="logo-icon"><FontAwesomeIcon icon="fa-solid fa-house" /></span></Link>
